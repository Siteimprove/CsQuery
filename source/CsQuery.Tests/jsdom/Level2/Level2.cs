...
namespace CsQuery.Tests.jsdom
{
    ...
    public class Level2 : JsDomTest_Level2
    {
           /// <summary>
           /// Some tests migrated from tmpvar/jsdom. A lot of these are HTML4 and generally pretty
           /// pointless since they merely test an attribute value.
           /// </summary>
          ...
          public void HTMLAnchorElement04() {
            ...
            Assert.AreEqual(nodeList.Length, 1, "Asize");
            Assert.AreEqual(((IHTMLAnchorElement)nodeList.Item(0)).Href, "./pix/submit.gif", "hrefLink");
          }
        ...
        //   */
          ...
          public void HTMLAnchorElement05() {
            ...
            var nodeList = doc.GetElementsByTagName("a");
            Assert.AreEqual(nodeList.Length, 1, "Asize");
            var testNode = (IHTMLAnchorElement)nodeList.Item(0);
            var vhreflink = testNode.Hreflang;
            Assert.AreEqual(vhreflink, "en", "hreflangLink");
          }
        ...
        public void  HTMLAnchorElement06() {
            ...
            Assert.AreEqual(nodeList.Length, 1, "Asize");
            var testNode = (IHTMLAnchorElement)nodeList.Item(0);
            var vname = testNode.Name;
            Assert.AreEqual(vname, "Anchor", "nameLink");
          }
        ...
        //  },
           ...
           */
          [Test, TestMethod]
          public void HTMLSelectElement01()
          {
            var doc = Load("select");
            var nodeList = doc.GetElementsByTagName("select");
            Assert.AreEqual(nodeList.Length, 3, "Asize");
            var testNode = nodeList.Item(0);
            var vtype = testNode.Type;
            Assert.AreEqual(vtype, "select-multiple", "typeLink");
         ...
         */
        [Test, TestMethod]
        public void HTMLSelectElement02()
        {
            var doc = Load("select");
            var nodeList = doc.GetElementsByTagName("select");
            Assert.AreEqual(nodeList.Count, 3, "Asize");
            var testNode = (IHTMLSelectElement)nodeList.Item(0);
            var vselectedindex = testNode.SelectedIndex;
            Assert.AreEqual(vselectedindex, 0, "selectedIndexLink");
        }
           ...
           */
            [Test, TestMethod]
            public void HTMLSelectElement03()
            {
                var doc = Load("select");
                var nodeList = doc.GetElementsByTagName("select");
                Assert.AreEqual(nodeList.Length, 3, "Asize");
                var testNode = (IHTMLSelectElement)nodeList.Item(1);
                var vselectedindex = testNode.SelectedIndex;
              }
        ...
        //  },
           ...
           */
         [Test, TestMethod]
            public void HTMLSelectElement05() 
         {
            var doc = Load("select");
            var nodeList = doc.GetElementsByTagName("select");
            Assert.AreEqual(nodeList.Length, 3, "Asize");
            var testNode = nodeList.Item(0);
            var vlength = ((IHTMLSelectElement)testNode).Length;
            Assert.AreEqual(vlength, 5, "lengthLink");
          }
        ...
        #region deprected: not part of HTML5
        //  /**
        //   *
